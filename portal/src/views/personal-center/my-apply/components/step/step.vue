  ...
  <div
    ...
    <div class="el-step__main">
      <div
        ...
        ref="title"
        :class="['is-' + currentStatus, 'step-title']">
        <slot name="title">{{ title }}</slot>
      </div>
      <div v-if="isSimple" class="el-step__arrow"></div>
      <div
        v-else
        class="el-step__description step-descrip"
        :class="['is-' + currentStatus]">
        <slot name="description">{{ description }}</slot>
      </div>
      <div :class="['el-step__comment', 'is-' + currentStatus]" >
...
<style scoped>
  ...
  .el-step.is-center .el-step__comment {
    padding-left: 20%;
    padding-right: 20%
  }
  .el-step__comment.is-process {
    color: #303133
  }

  .el-step__comment.is-wait {
    color: #c0c4cc
  }

  .el-step__comment.is-success {
    color: #67c23a
  }

  .el-step__comment.is-error {
    color: #f56c6c
  }

  .el-step__comment.is-finish {
    color: #409EFF
  }
</style>
