...
<script>
  export default {
    ...
    methods: {
      handleScroll() {
        let dom = document.querySelector('.container') || document.querySelector('.baseContainer');
      ...
      backToTop() {
        ...
        this.interval = setInterval(() => {
          const next = Math.floor(_that.easeInOutQuad(10 * i, start, -start, 200));
          if (next <= _that.backPosition) {
            dom.scrollTo(0, _that.backPosition)
